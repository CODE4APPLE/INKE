...
static CGFloat const kTitleFont = 16;
static CGFloat const kPriceFont = 15;
static CGFloat const kImageWidth = 60;

@interface HotestTableViewCell ()

@end

@implementation HotestTableViewCell
