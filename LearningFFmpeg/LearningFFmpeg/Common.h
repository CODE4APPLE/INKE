...
#define navigationBarColor     [UIColor colorWithRed:0.569 green:0.882 blue:0.827 alpha:1.00]

#define bgroundColor [UIColor colorWithRed:0.933f green:0.937f blue:0.941f alpha:1.00f]
#define orange  [UIColor colorWithRed:0.984 green:0.749 blue:0.420 alpha:1.00]
